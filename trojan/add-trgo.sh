...
linktrgo="trojan-go://${uuidR}@${domain}:${trgo}/?sni=${domain}&type=ws&host=${domain}&path=/rajakapur&encryption=none#${user}"
clear
...
echo -e "Path : /rajakapur" | tee -a /etc/log-create-user.log

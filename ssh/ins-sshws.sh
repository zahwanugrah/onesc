...
wget -q -O /usr/bin/ssh-wsenabler "https://raw.githubusercontent.com/izhanworks/izscrprem/main/ssh/sshws-true.sh" && chmod +x /usr/bin/ssh-wsenabler && /usr/bin/ssh-wsenabler

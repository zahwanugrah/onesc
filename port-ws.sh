...
echo -e "======================================"
echo -e "      Change Port V2RAY Vmess"
echo -e ""
echo -e "     [1]  Change Port V2RAY Vmess TLS $tls"
echo -e "     [2]  Change Port V2RAY Vmess None TLS $none"
echo -e "     [x]  Exit"
echo -e "======================================"
echo -e ""
...
read -p "New Port V2RAY Vmess None TLS: " none1
if [ -z $none1 ]; then
echo "Please Input Port"
exit 0
fi

...
LLatest=`date`
Get_Data () {
git clone https://github.com/rajakapur/LOG-USER.git /etc/user-update/ &> /dev/null
}
...
Save_And_Exit () {
    ...
    git remote add origin https://github.com/rajakapur/LOG-USER
    git push -f https://Token Github@github.com/rajakapur/LOG-USER.git &> /dev/null
}

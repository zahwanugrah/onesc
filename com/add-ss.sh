...
# =======================================
proxies:
  - {name: SS_TLS_clash@vpn123, server: ${BUG}.${domain}, port: $tls, type: ss, cipher: aes-256-cfb, password: $user, plugin: obfs, plugin-opts: {mode: tls, host: $BUG}}
  - {name: SS_HTTP_clash@vpn123, server: ${BUG}.${domain}, port: $http, type: ss, cipher: aes-256-cfb, password: $user, plugin: obfs, plugin-opts: {mode: http, host: $BUG}}
port: 3333
socks-port: 23456
redir-port: 23457
allow-lan: true

...
clear
echo -e "${Info} V2ray CORE VPS Autoone by vpn123"
# Detect public IPv4 address and pre-fill for the user
# Domain
domain=$(cat /etc/rare/xray/domain)
# Uuid Service
uuid=$(cat /proc/sys/kernel/random/uuid)
echo -e "\e[0;32m V2ray CORE VPS Autoone by vpn123\e[0m"
echo -e "\e[0;32m TELEGRAM @vpn123\e[0m"
sleep 5
# NGINX V2RAY CONF
...
[Unit]
Deoneion=V2Ray - A unified platform for anti-censorship
...
cd /usr/bin
wget -O v2ray-menu "https://raw.githubusercontent.com/rajakabur/onesc/main/v2ray-menu.sh"
chmod +x v2ray-menu
cd
systemctl daemon-reload

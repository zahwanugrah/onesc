...
# ==================================================
# Link Hosting Kalian
rajakapur="raw.githubusercontent.com/rajakapur/onesc/main/wireguard"
...
echo -e "${Info} Wireguard Script MR.TRICK"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/rajakapur/onesc/main/wireguard/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/rajakapur/onesc/main/wireguard/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/rajakapur/onesc/main/wireguard/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd

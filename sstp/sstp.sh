...
curl -sS "https://raw.githubusercontent.com/rajakapur/onesc/main/sstp/accel.conf" | openssl aes-256-cbc -d -a -pass pass:rajakapur07gg -pbkdf2 > /etc/accel-ppp.conf

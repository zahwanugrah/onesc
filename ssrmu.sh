...
menu_status
  ...
  ${Green_font_prefix}10.${Font_color_suffix} Upgrade one 
  
  ${Tip} Username And User Port Can Not Be Changed, If You Need To Modify, Use The one To Manually Change The Function!
 "

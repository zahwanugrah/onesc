...
echo -e "======================================"
echo -e "      Change Port V2RAY Vless"
echo -e ""
echo -e "     [1]  Change Port V2RAY Vless TLS $tls"
echo -e "     [2]  Change Port V2RAY Vless None TLS $none"
echo -e "     [x]  Exit"
echo -e "======================================"
echo -e ""
...
case $prot in
1)
read -p "New Port V2RAY Vless TLS: " tls1
if [ -z $tls1 ]; then
...
;;
2)
read -p "New Port V2RAY Vless None TLS: " none1
if [ -z $none1 ]; then
echo "Please Input Port"
exit 0
fi
